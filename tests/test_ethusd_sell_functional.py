...
class TestsEthUsdSell:
    ...
    def test_maker_or_cancel_fulfill():
        ...
        payload = Payload.create_limit_payload_sell("ethusd", amount, price, options)
    ...
    def test_stop_limit_order():
        ...
        payload = Payload.create_stop_limit_payload_sell("ethusd", amount, price, stop_price)
    ...
    def test_negative_stop_limit_order():
        amount = "0.1"
        price = str('{0:.2f}'.format(Prices.current_price_ETHUSD))
        stop_price = str('{0:.2f}'.format(Prices.current_price_ETHUSD - 100))
        payload = Payload.create_stop_limit_payload_sell("ethusd", amount, price, stop_price)
